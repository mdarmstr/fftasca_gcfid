function fig_h = plot_scatterm(bdata, varargin)
...
%               classes in Z-axis
%
%   By default, opt = '100'. If less digits are specified, least significant
...
%
% 'Colormap': Nx3 colormap for the plot (default colormap used if not specified)
%
%
% OUTPUTS:
%
...
% Use specified colormap if provided, otherwise use default colormap
if isempty(cmap)
    if opt(1) == '0'
